...
static char rcsid[] = "$Id: flags.c,v 1.4 2000/02/09 21:03:15 mud Exp $";
...
void do_flag(CHAR_DATA *ch, char *argument)
{
	...
	send_to_char("  char flags: plr,comm,aff,imm,res,vuln,mhs\n\r",ch);
