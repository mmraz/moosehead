...
void load_notes(void)
{
    ...
    load_thread(OOC_FILE,&ooc_list, NOTE_OOC, 14*24*60*60);
    load_thread(BUG_FILE,&bug_list,NOTE_BUG, 90*24*60*60);
    load_thread(IDEA_FILE,&idea_list, NOTE_IDEA, 14*24*60*60);
    ...
    load_thread(CLAN_FILE,&clan_list,NOTE_CLAN, 14*24*60*60);
    load_thread(IMMORTAL_FILE,&immortal_list, NOTE_IMMORTAL, 30*24*60*60);
